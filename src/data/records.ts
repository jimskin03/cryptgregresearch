...
export const projects: Project[] = [
  { id: 'eastern-paradise', name: 'Eastern Paradise', strapline: 'A transparent sanctuary economy built for inspection.', description: 'A transparent sanctuary economy built for inspection.', status: 'LIVE', kind: 'simulation', externalUrl: 'https://simulation.cryptgregresearch.org/', statusCheckedAt: checked, featured: true, isFixture: true, metrics: [] },
  ...
  { id: 'beacon-relay', name: 'Beacon Relay', strapline: 'An agentic + human play concept under active exploration.', description: 'An agentic + human play concept under active exploration.', status: 'IN DEVELOPMENT', kind: 'research experiment', externalUrl: 'https://beacon-relay-gregy.onrender.com/', statusCheckedAt: checked, verificationNote: 'Concept status; no live-service claim.', isFixture: true, featured: false, metrics: [] },
];
