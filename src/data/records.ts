...
export const projects: Project[] = [
  ...
  { id: 'expense-tracker', name: 'CryptGreg Finance', strapline: 'One private workspace for your Ledger, compound-growth calculator, and Portfolio.', description: 'One private finance workspace for Ledger, compound growth, and ISIN-based Portfolio tracking.', status: 'LIVE', verificationStatus: 'VERIFIED', kind: 'finance workspace', externalUrl: 'https://equity-tracker-latest.onrender.com/', statusCheckedAt: checked, featured: false, isFixture: false, metrics: [] },
