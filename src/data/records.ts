...
export const projects: Project[] = [
  ...
  { id: 'nightshift', name: 'Nightshift / Template Demo', strapline: 'A public-facing experiment in rapid web interfaces.', description: 'A public-facing experiment in rapid web interfaces.', status: 'UNVERIFIED', kind: 'web experiment', externalUrl: 'https://templatedemo.ct.ws/', statusCheckedAt: checked, verificationNote: 'Browser-side verification deferred; server check did not resolve.', isFixture: true, featured: false, metrics: [] },
